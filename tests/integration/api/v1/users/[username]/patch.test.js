    ...
    test("With unique 'username'", async () => {
      const user1Response = await fetch("http://localhost:3000/api/v1/users", {
        ...
        body: JSON.stringify({
          ...
          email: "uniqueUser1@john_doe.com",
          password: "senha123",
        }),
      });
    ...
    test("With unique 'email'", async () => {
      const user1Response = await fetch("http://localhost:3000/api/v1/users", {
        ...
        body: JSON.stringify({
          ...
          email: "uniqueEmail1@john_doe.com",
          password: "senha123",
        }),
      });
      ...
      const response = await fetch(
        "http://localhost:3000/api/v1/users/uniqueEmail1",
        {
          ...
          body: JSON.stringify({
            email: "uniqueEmail2@john_doe.com",
          }),
        },
      );
    ...
    test("With new 'password'", async () => {
      const user1Response = await fetch("http://localhost:3000/api/v1/users", {
        ...
        body: JSON.stringify({
          ...
          email: "newPassword1@john_doe.com",
